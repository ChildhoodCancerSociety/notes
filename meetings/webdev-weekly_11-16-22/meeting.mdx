...
* why?
  ...
  * lots of meetings, need to empower PMs and
* powered primarily by `mdx-deck`
  * not a good idea :(
    ...
    * build output is ~400 files and ~8MB (!!!)
  * evaluating `MDXP` as a replacement
  * any other presentation software (does not have to be node/js based!) is fine

---
# TODO

* find some replacement for `mdx-deck`
* dev tooling (located in `index.js`)
* build tooling
  * does not exist :P
